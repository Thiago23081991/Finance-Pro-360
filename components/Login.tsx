...
<<<<<<< HEAD
    ...
    try {
      if (authMode === 'recovery') {
        ...
        const { session } = await DBService.registerUser({
          name: cleanName,
          username: cleanEmail,
        ...
        // If session exists, App.tsx will auto-detect change via onAuthStateChange
      } else {
        ...
        if (user) {
          ...
          // App.tsx will auto-detect change via onAuthStateChange
        }
      }
    } catch (err: any) {
