    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] p-4 text-center space-y-8 animate-fade-in fade-in-0 duration-700">
            <div className="w-24 h-24 bg-brand-gold/10 rounded-full flex items-center justify-center relative mb-4">
                ...
                <div className="absolute -top-2 -right-2 bg-brand-blue text-white text-[10px] uppercase font-bold px-2 py-1 rounded-full border border-white/10 shadow-md">
                    Premium
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 md:p-8 w-full max-w-sm shadow-xl relative overflow-hidden">
